...
abstract class $ExerciseSetCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, int reps, double weight});
}
...
class _$_ExerciseSet implements _ExerciseSet {
  const _$_ExerciseSet(
      {required this.name, required this.reps, required this.weight});
  ...
  @override
  String toString() {
    return 'ExerciseSet(name: $name, reps: $reps, weight: $weight)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, reps, weight);
...
abstract class _ExerciseSet implements ExerciseSet {
  const factory _ExerciseSet(
      ...
      required final double weight}) = _$_ExerciseSet;
