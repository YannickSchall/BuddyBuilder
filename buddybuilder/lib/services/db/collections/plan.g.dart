...
extension PlanQueryWhere on QueryBuilder<Plan, Plan, QWhereClause> {
  ...
  QueryBuilder<Plan, Plan, QAfterWhereClause> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Plan, Plan, QAfterWhereClause> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension PlanQueryFilter on QueryBuilder<Plan, Plan, QFilterCondition> {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'splits',
      ));
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'splits',
      ));
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'splits',
        0,
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'splits',
        0,
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlanQueryObject on QueryBuilder<Plan, Plan, QFilterCondition> {
  QueryBuilder<Plan, Plan, QAfterFilterCondition> splitsElement(
      FilterQuery<Split> q) {
    return QueryBuilder.apply(this, (query) {
...
extension PlanQueryProperty on QueryBuilder<Plan, Plan, QQueryProperty> {
  ...
  QueryBuilder<Plan, List<Split>?, QQueryOperations> splitsProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension SplitQueryFilter on QueryBuilder<Split, Split, QFilterCondition> {
  ...
  QueryBuilder<Split, Split, QAfterFilterCondition> idEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: value,
